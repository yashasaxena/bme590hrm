...
def test_datatype():
    ...
    with pytest.raises(TypeError):
        ...
        x.type_check('FaultyData_UnitTest2.csv')
...
def test_valuerange():
    ...
    with pytest.raises(ValueError):
        x = SC.Data('FaultyData_UnitTest2.csv')
        x.practicality_check('FaultyData_UnitTest2.csv')
...
def test_dataisgood():
    ...
    assert x.type_check('GoodData_UnitTest.csv') == 1
    assert x.practicality_check('GoodData_UnitTest.csv') == 1